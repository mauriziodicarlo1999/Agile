    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card card-solid">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-sm-6" style="margin-left: 30px;">
                            <h2 class="my-3" style="text-transform: capitalize;">{{ $topic->titolo }}</h2>

                            <p>Nome: {{ $topic->titolo }}</p>
                            <p>Data di creazione: {{ $topic->created_at }}</p>
                            <p>Creatore: {{ $topic->creator->nome }}</p>
                            <hr>
                    ...
                    <div class="row mt-4">
                        <nav class="w-100">
                            <div class="nav nav-tabs" id="product-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">Commenti</a>
                            </div>
                        </nav>
                        <div class="tab-content p-3" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab" style="font-size: 13px;" > {{ $topic->descrizione }}</div>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
